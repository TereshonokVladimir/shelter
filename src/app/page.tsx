      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col gap-12 px-4 py-16 md:py-24">
        <section className="bunker-phase-enter relative flex max-w-2xl flex-col gap-5">
          ...
          <p className="text-xs uppercase tracking-[0.35em] text-amber-200/70">
            Онлайн · убежище · голосование
          </p>
          <h1 className="font-[family-name:var(--font-display)] text-5xl leading-[0.95] text-stone-50 md:text-7xl">
            {APP_NAME}
          </h1>
          <p className="max-w-xl text-base text-stone-300 md:text-lg">
            Катастрофа уже здесь. Мест в убежище меньше, чем игроков. Раскрывайте факты,
            спорьте и решайте голосованием, кто останется под защитой.
          </p>
        ...
        <section className="grid gap-6 md:grid-cols-[1.1fr_0.9fr]">
          <div className="overflow-hidden rounded-2xl border border-amber-900/40 bg-stone-950/55 shadow-[inset_0_1px_0_rgba(251,191,36,0.08)] backdrop-blur">
          ...
          <div className="overflow-hidden rounded-2xl border border-stone-700/55 bg-stone-950/55 backdrop-blur">
            <div className="bunker-hazard-stripe h-2 opacity-60" />
            <div className="p-6">
